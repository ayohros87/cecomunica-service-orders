...
4. **Penalidad de baja (versión FINAL 2026-08-27)** — la liquidación **siempre equivale a 3 meses de mensualidad, cobrados de inmediato**, evaluada por el tramo de cada ítem (igual para bajas parciales y terminación total): tramo/contrato **no vencido** → los 3 meses son penalidad pura; **vencido** (mes a mes) → 60 días son **preaviso con el servicio activo** hasta su término + 30 días de penalidad. La gestión de baja calcula y muestra la liquidación **por contrato afectado**.
