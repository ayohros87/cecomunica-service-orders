...
window.FinanzasNav = {
  ...
  // con lo que Recepción hace en QuickBooks.
  // Este espacio es SOLO admin/contabilidad (información financiera de la
  // empresa, need-to-know). Recepción entra a la bandeja por su propio módulo
