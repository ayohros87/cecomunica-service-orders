// Predicados de PENDIENTE — espejo del navegador.
//
// DUPLICADO A PROPÓSITO de functions/src/domain/pendientes.js (no hay build
// step que comparta código entre navegador y functions — mismo trato que la
...
// obliga a tocar el otro. El cuerpo de las funciones es COPIA LITERAL del
// archivo del servidor — no lo "mejores" solo aquí.
//
// Consumidores: senalesService (conteos y filas de la bandeja del home),
// ordenes-qc.js (estado del QC), ordenesService.listQcPendientes.
window.PendientesDomain = (() => {
