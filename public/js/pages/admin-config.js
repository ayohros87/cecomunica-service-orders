...
(function () {
  ...
  const FIELDS = [
    ...
    { key: 'cotizacion_descuento_max_pct', section: 'facturacion', label: 'Descuento máximo sin aprobación (%)',
      type: 'int',  min: 0,     max: 100,
      hint: 'Un vendedor envía la cotización al cliente él mismo mientras el descuento no pase de este porcentaje; por encima, requiere aprobación. Cuenta el MAYOR de los dos: el descuento global y el descuento de cualquier renglón — 25% en un solo renglón ya pide aprobación aunque el global sea 0%. Aplica a cotizaciones nuevas y a las que se editen; no reevalúa las ya enviadas.' },
    { key: 'cotizacion_total_max', section: 'facturacion', label: 'Total máximo sin aprobación (USD)',
      type: 'int',  min: 0,     max: 1000000,
      hint: 'Total (con ITBMS) hasta el cual un vendedor envía la cotización sin aprobación. Por encima, requiere aprobación aunque no lleve ningún descuento. Se evalúa junto con el descuento máximo: basta que uno de los dos se exceda.' },
    ...
    { key: 'mail_orden_creada_to', section: 'correos', label: 'Nueva orden creada → aviso',
      type: 'user-picker', emptyHint: 'se notifica a tecnico@cecomunica.com',
      hint: 'Quién recibe el aviso cuando se crea una orden de servicio (antes iba fijo a tecnico@cecomunica.com). El primero va como destinatario y el resto en copia. Vacío = tecnico@cecomunica.com.' },
